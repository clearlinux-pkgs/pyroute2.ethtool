...
Version  : 0.6.5
Release  : 10
URL      : https://files.pythonhosted.org/packages/5a/0d/b6842106b480d2433a9062870a91eca7d03681b74f2a5fb29af89d945d87/pyroute2.ethtool-0.6.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/5a/0d/b6842106b480d2433a9062870a91eca7d03681b74f2a5fb29af89d945d87/pyroute2.ethtool-0.6.5.tar.gz
...
%prep
%setup -q -n pyroute2.ethtool-0.6.5
cd %{_builddir}/pyroute2.ethtool-0.6.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632181875
...
cp %{_builddir}/pyroute2.ethtool-0.6.5/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2.ethtool/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ethtool-0.6.5/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2.ethtool/4cc77b90af91e615a64ae04893fdffa7939db84c
