...
Version  : 0.6.3
Release  : 2
URL      : https://files.pythonhosted.org/packages/e9/b3/cc75e4cf37aad4ffc82256a93841cb38d4dbd16bc19e27895bf2159ce26d/pyroute2.ethtool-0.6.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/e9/b3/cc75e4cf37aad4ffc82256a93841cb38d4dbd16bc19e27895bf2159ce26d/pyroute2.ethtool-0.6.3.tar.gz
...
%prep
%setup -q -n pyroute2.ethtool-0.6.3
cd %{_builddir}/pyroute2.ethtool-0.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622561302
...
cp %{_builddir}/pyroute2.ethtool-0.6.3/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2.ethtool/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ethtool-0.6.3/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2.ethtool/4cc77b90af91e615a64ae04893fdffa7939db84c
